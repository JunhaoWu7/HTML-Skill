...
4. Read the pinned upstream `../../external/figures4papers/scientific-figure-making/SKILL.md`, then open only the upstream references and `figure_*` demos relevant to the requested chart. Keep attribution and do not edit the external submodule.
